...
<head>
    ...
    if ($loggedIn) {
        if ($_SESSION["role"] === "admin") {
            ...
            echo "<script src = '../js/reviews/reviewListener.js'></script>"; // Handle review creation
            echo "<script src='../js/reviews/reviewsStyleAdmin.js'></script>";
            echo "<script src='../js/reviews/reviewsStyleRefresher.js'></script>";
            echo "<script src = '../js/reviews/scrollReviewsAdmin.js'></script>"; // Admin infinite scroll with delete options
        }else{ 
            // Regular users can only view reviews
            echo "<script src='../js/reviews/reviewsStyle.js'></script>";
            echo "<script src = '../js/reviews/scrollReviews.js'></script>";
        }
    }else { 
        // Non-logged in users can only view reviews
        echo "<script src = '../js/reviews/scrollReviews.js'></script>"; // Standard infinite scroll
    }
